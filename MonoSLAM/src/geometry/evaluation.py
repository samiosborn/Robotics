"""Evaluation utilities for two-view model estimates."""

import numpy as np

from geometry.camera import Camera
from geometry.distances import sampson_rmse
from geometry.pose import pose_from_fundamental, angle_between_translations
from geometry.rotation import angle_between_rotmats
from geometry.triangulation import triangulate_points


def evaluate_two_view_model(tag, F_est, x1, x2, K1, K2, x1_clean=None, x2_clean=None, X_true=None, R_true=None, t_true=None, cam1=None, true_inlier_mask=None, pred_inlier_mask=None):
