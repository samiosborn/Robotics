...
def pnp_diagnostic_summary_stats(pose_stats: dict[str, Any], *, pnp_component_radius_px: float = 80.0) -> dict[str, Any]:
    return {
        ...
        "pnp_incoherent_recovery_attempted": bool(pose_stats.get("pnp_incoherent_recovery_attempted", False)),
        "pnp_incoherent_recovery_succeeded": bool(pose_stats.get("pnp_incoherent_recovery_succeeded", False)),
        "pnp_incoherent_recovery_reason": pose_stats.get("pnp_incoherent_recovery_reason", None),
        "pnp_incoherent_recovery_source_kf": int(pose_stats.get("pnp_incoherent_recovery_source_kf", -1)),
        "pnp_incoherent_recovery_base_n_corr": int(pose_stats.get("pnp_incoherent_recovery_base_n_corr", 0)),
        "pnp_incoherent_recovery_candidate_n_corr": int(pose_stats.get("pnp_incoherent_recovery_candidate_n_corr", 0)),
        "pnp_incoherent_recovery_candidate_n_inliers": int(pose_stats.get("pnp_incoherent_recovery_candidate_n_inliers", 0)),
