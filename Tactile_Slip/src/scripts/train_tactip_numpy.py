...
def main():
    ...
    # Build TRAIN with groups (g) for sequence-level splitting
    ...
    # Build TEST (optionally return groups as well)
    ...
    # Build train-sub and validation from a sequence-level (group) split
    ...
    params, Xtr_sub, ytr_sub,
    cfg["padding"], cfg["stride"], cfg["pool_size"], cfg["pool_stride"],
    lr=0.0, batch_size=64, weight_decay=0.0, pos_weight=cfg["pos_weight"])
