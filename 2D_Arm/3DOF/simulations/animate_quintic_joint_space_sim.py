# simulations/animate_quintic_joint_space_sim.py
import sys
import os
...
import numpy as np
import config
from trajectory.joint_space_trajectory import quintic_joint_space_trajectory
from trajectory.animate_trajectory import animate_angles_trajectory

# Animate quintic joint-space trajectory
def animate_quintic_joint_space():
